...
import com.coinomi.core.coins.IoncoinMain;
...
public class Constants {
    ...
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
            ...
            new CoinAddress(IoncoinMain.get(),      new ServerAddress("ion-cce-1.coinomi.net", 5048),
                                                    new ServerAddress("ion-cce-2.coinomi.net", 5048))
    );
...
//        COINS_ICONS.put(CoinID.URO_MAIN.getCoinType(), R.drawable.uro);
        ...
        COINS_ICONS.put(CoinID.IONCOIN_MAIN.getCoinType(), R.drawable.ioncoin);
